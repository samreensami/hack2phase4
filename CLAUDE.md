...
- `backend/` - Contains all backend services and APIs
- `frontend/` - Contains all frontend applications and UI components
- `specs/` - Contains all specifications, requirements, and design documents
- `.spec-kit/` - Contains configuration for the spec-kit tooling
